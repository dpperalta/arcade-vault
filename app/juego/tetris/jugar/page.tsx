...
export default function TetrisPlayer() {
  ...
  useEffect(() => {
    ...
    const handle = createTetris(canvas, {
      onState: (s) => setGs(s),
      onGameOver: (fs) => {
        setFinalScore(fs);
        setOver(true);
    ...
    // Mundo responsive: re-mide y recoloca el tablero cuando cambia el tamaño del canvas.
